...
const token = 'OTU3MzU4ODA0NTM2ODA3NTA3.Yj9n3Q.vFT7xkKC-ajgMi5Vq28YeSlRqks'; //get the token in .env
const guild = '952938135464054784'; //get the guild ID in .env
const application_id = '957358804536807507'; //get the application ID in .env
